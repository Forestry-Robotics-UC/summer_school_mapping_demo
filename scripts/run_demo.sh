...
SUMMER_SCHOOL_RAW_BAG_PATTERN="${SUMMER_SCHOOL_RAW_BAG_PATTERN:-${SUMMER_SCHOOL_RAW_BAG:-raw/2026_03_25_15_24_28__event-near_points__0_ros1_chunk_*.bag}}"
SUMMER_SCHOOL_PRUNE_BAG="${SUMMER_SCHOOL_PRUNE_BAG:-semantic_pcl/prune_colored_event_near_points_480p.bag}"
SUMMER_SCHOOL_SKY_MASK_BAG="${SUMMER_SCHOOL_SKY_MASK_BAG:-raw/sky_mask_event_near_points_480p.bag}"
